...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            ImGui::SameLine(); HelpMarker("Pressing Enter will keep item running and select contents (single-line only).");
...
static void ShowDemoWindowPopups()
{
    ...
    {
        ImGui::TextWrapped(
            "When a popup is running, it inhibits interacting with windows that are behind the popup. "
    ...
    if (ImGui::TreeNode("Advanced"))
    {
        ...
        if (ImGui::TreeNode("Options"))
        {
            ...
            if (ImGui::TreeNodeEx("Other:", ImGuiTreeNodeFlags_DefaultOpen))
            {
                ...
                ImGui::DragFloat("inner_width (when ScrollX running)", &inner_width_with_scroll, 1.0f, 0.0f, FLT_MAX);
